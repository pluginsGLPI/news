...
xgettext *.php */*.php --copyright-holder='Resources Development Team' --package-name='GLPI - News plugin' --package-version='1.5.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
